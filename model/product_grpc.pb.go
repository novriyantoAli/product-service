...
const (
	Products_Find_FullMethodName = "/model.Products/Find"
)
...
type ProductsClient interface {
	Find(ctx context.Context, in *Product, opts ...grpc.CallOption) (*ProductList, error)
}
...
func (c *productsClient) Find(ctx context.Context, in *Product, opts ...grpc.CallOption) (*ProductList, error) {
	out := new(ProductList)
...
type ProductsServer interface {
	Find(context.Context, *Product) (*ProductList, error)
...
func (UnimplementedProductsServer) Find(context.Context, *Product) (*ProductList, error) {
...
func _Products_Find_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductsServer).Find(ctx, req.(*Product))
	}
